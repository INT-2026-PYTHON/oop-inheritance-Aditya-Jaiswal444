...
class Manager(Employee):
    """Level 3: Inherits from Employee"""
...
# Call greet() and work_intro() on each employee
print(e1.greet())
print(e1.work_intro())
print()
...
# Create one Manager and add employees to her team
m = Manager("Carol", 40, "M001", 150000, [])
m.add_member(e1)
m.add_member(e2)

# Call greet(), work_intro(), and team_intro() on manager
print(m.greet())
print(m.work_intro())
print(m.team_intro())
print()
...
# Change bonus to 10% and apply again
Employee.set_bonus(10)
m.apply_bonus()  # inherited, now at 10%
